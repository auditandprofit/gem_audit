...
module Gitlab
  module Agent
    module Entity
      AgentkMeta = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("gitlab.agent.entity.AgentkMeta").msgclass
      AgentwMeta = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("gitlab.agent.entity.AgentwMeta").msgclass
