...
module Gitaly
  ...
  LogEntry::Housekeeping::Offloading = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("gitaly.LogEntry.Housekeeping.Offloading").msgclass
